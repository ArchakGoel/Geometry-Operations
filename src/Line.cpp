...
namespace Entities {
  ...
  bool Line::operator==(const Line &rhs) const {
    return (MathUtils::isEqual(vertex1, rhs.vertex1) &&
            MathUtils::isEqual(vertex2, rhs.vertex2)) ||
           (MathUtils::isEqual(vertex1, rhs.vertex2) &&
            MathUtils::isEqual(vertex2, rhs.vertex1));
  }

  bool Line::operator!=(const Line &rhs) const { return !(*this == rhs); }
