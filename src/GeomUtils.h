    ...
    public:
      ...
      Point intersectionPoint() const {
        ...
        if (intersects) {
          ...
          auto pointVector = Vector3D(line1.getFirstPoint().getX(),
                                      line1.getFirstPoint().getY(),
                                      line1.getFirstPoint().getZ());

          pointVector = (line1.getDirection() * paramLine1) + pointVector;

          return Point(pointVector.getX(), pointVector.getY(),
                       pointVector.getZ());
